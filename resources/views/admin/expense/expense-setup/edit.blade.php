                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header bg-primary text-center">
                                <h3 class="card-title pt-2" style="width:100%; text-align:center">Edit Schedule Setup</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <!-- /.card-header -->
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class=" form-group">
                                                        ...
                                                        <select name="exp_id" id="exp_id" class="form-control">
                                                            ...
                                                            @foreach ($expenses as $expense)
                                                                <option value="{{ $expense->id }}"@if ($expense->id == $exp->exp_id) selected @endif  >{{ $expense->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{$exp->interval_days}}"
