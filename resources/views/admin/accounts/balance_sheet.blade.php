                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                                <tr>
                                                    <td class="text-right">{{ $total_exp }}</td>
                                                    <td class="text-right">{{ $total_income }}</td>
                                                    <td class="text-right">{{ $total_income - $total_exp}}</td>
                                                    <td class="text-center">
                                                        @if (($total_income - $total_exp) > 0)
                                                            <span class="badge badge-primary">Profit</span>
                                                            @else
                                                            <span class="badge badge-primary">Loss</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                    </tbody>
