...
@section('admin_content')
    <div class="content-wrapper">
        ...
        @php
            ...
            $flats = App\Models\Flat::where('customer_id', Auth::guard('admin')->user()->id)->count();
            $expense = App\Models\Exp_detail::where('customer_id', Auth::guard('admin')->user()->id)
                ->where('date', date('Y-m'))
                ->sum('amount');
            $income = App\Models\Income::where('customer_id', Auth::guard('admin')->user()->id)
                ->where('date', date('Y-m'))
                ->sum('paid');
            ...
            $others_income = DB::table('others_incomes')
                ...
                ->where('date', date('Y-m'))
                ->sum('amount');
            $balance = App\Models\MonthlyBlance::where('customer_id', Auth::guard('admin')->user()->id)
                ->where('date', date('Y-m'))
                ->sum('amount');
