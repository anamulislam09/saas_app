                                                ...
                                                <td><input type="hidden" name="customer_id" value="{{ $item->flat_name }}"></td> --}}
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="name"
                                                                style="width: 140px; border:none" placeholder="User name" required>
                                                        </td>
                                                        <td><input type="text" name="phone"
                                                                style="width: 140px ; border:none" placeholder="User phone" required>
                                                        </td>
                                                        ...
                                                        <td><input type="email" name="email"
                                                                style="width: 140px ; border:none" placeholder="User email" required>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                <tr>
